...
public abstract class Itinerary
{
	...
	/**
	 * Decreases the number of seats in all flights in itinerary
	 * 
	 */
	public void decreaseNumSeats()
	{
		for (Flight flight : this.flights)
		{
			flight.removeOneSeat();
		}
	}

	/**
	 * Increases the number of seats in all flights in itinerary
	 * 
	 */
	public void increaseNumSeats()
	{
		for (Flight flight : this.flights)
		{
			flight.addOneSeat();
